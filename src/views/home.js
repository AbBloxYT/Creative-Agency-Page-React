      ...
      <main className="home-main">
        <div className="home-hero section-container">
          <div className="home-max-width max-content-container">
            <div className="home-heading-container">
              <h1 className="home-text">welcome to my site</h1>
              <span className="home-text01">
                it&apos;s very cool, scroll down!
              </span>
        ...
        <div className="section-container">
          <div className="home-max-width2 max-content-container">
            <div className="home-text-container1">
              <span className="home-text08">our work</span>
              <h2 className="home-text09 heading2">
                <span>Explore our portfolio</span>
              </h2>
              <span className="home-text11">
                i&apos;ve done some things, look down!
              </span>
            ...
            <div className="home-text-container2">
              ...
              <div className="home-checklist">
                ...
                <div className="home-check-item4">
                  ...
                  <span className="home-text28">Future-Proofing Projects</span>
                </div>
        ...
        <div className="home-process section-container">
          <div className="home-max-width4 max-content-container">
            <span className="home-text30">Our process</span>
            ...
            <div className="home-step">
              <span className="home-text35">01</span>
              <div className="home-container5">
                <span className="home-text36">Finding the best idea</span>
            ...
            <div className="home-step2">
              ...
              <div className="home-container7">
                <span className="home-text42">Strong design execution</span>
        ...
        <div className="section-container">
          <div className="home-max-width5 max-content-container">
            <span className="home-text44">from blog</span>
        ...
        <div className="home-banner section-container">
          <div className="home-max-width6 max-content-container">
            <span className="home-text51">what are you waiting?</span>
      ...
      <div className="section-container">
          ...
          <div className="home-top-part">
            <div className="home-links-container">
              <div className="home-product-container">
                ...
                <span className="home-text60">Portofolio</span>
                <span>Blog</span>
              </div>
              <div className="home-navigate-container">
                <span className="home-text62">Navigate</span>
                <span className="home-text63">Copyrights</span>
                <span className="home-text64">Sitemap</span>
            ...
            <div className="home-subscribe-container">
              <span className="home-text75">Subscribe to our newsletter</span>
              <input
                type="text"
        ...
        <footer className="home-max-width8 max-content-container">
          ...
          <span className="home-text76">
            ...
            <span className="home-text80">teleporhq.io</span>
            <span>
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
